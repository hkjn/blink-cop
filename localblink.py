...
class CannotGetBuildStatusError(Exception):
...
def RunBlinkCmd(commands):
    ...
    child = subprocess.Popen(commands, stdout=subprocess.PIPE, stderr=subprocess.PIPE, close_fds=True)
...
def Run():
    ...
    while True:
        ...
        try:
            ...
            RunDiscoCmd()  # If nothing caught this, exit with a show.
            raise
